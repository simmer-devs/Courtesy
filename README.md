...
| Purge | !purge # | Bulk deletes the indicated number of messages from the channel. Only usable on messages less than 2 weeks old. Requires Administrator permissions. |
